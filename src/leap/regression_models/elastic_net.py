"""ElasticNet wrapper for LEAP that conforms to the RegressionModel interface."""
...
import numpy as np
import pandas as pd
from skglm import ElasticNet as SkglmElasticNet
...
class ElasticNet(RegressionModel):
    """Wrapper for skglm's ElasticNet that accepts pandas DataFrames.
    ...
    - Converting internally to numpy arrays as required by skglm
    - Providing a consistent interface with other LEAP regression models
    """

    def __init__(self, **kwargs: Any):
        self._model = SkglmElasticNet(**kwargs)
    ...
    def set_params(self, **params: Any) -> ElasticNet:
